    ...
    <Box flex={2} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
      <Box position="fixed">
        ...
        <AvatarGroup max={7}>
          ...
          <Avatar alt="Sharp Remy" src={avatar6} />
          <Avatar alt="Howard Travis" src={avatar7} />
          <Avatar alt="Baker Cindy" src={avatar8} />
          <Avatar alt="Walker Agnes" src={avatar9} />
          <Avatar alt="Henderson Trevor" src={avatar10} />
        </AvatarGroup>
        ...
        >
          ...
          <ListItem alignItems="flex-start">
            <ListItemAvatar>
              <Avatar alt="Travis Howard" src={avatar9} />
            </ListItemAvatar>
            <ListItemText
              primary="Summer BBQ"
              secondary={
          ...
          <ListItem alignItems="flex-start">
            <ListItemAvatar>
              <Avatar alt="Cindy Baker" src={avatar10} />
            </ListItemAvatar>
            <ListItemText
              primary="Oui Oui"
              secondary={
